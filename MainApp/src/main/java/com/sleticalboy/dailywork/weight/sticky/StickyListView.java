package com.sleticalboy.dailywork.weight.sticky;
 ...
 */
public class StickyListView extends ViewGroup implements OnDetectScrollListener {
    ...
    private void initDragHelper() {
        mDragHelper = ViewDragHelper.create(this, new ViewDragHelper.Callback() {
            ...
            public void onViewReleased(View releasedChild, float xvel, float yvel) {
                ...
                ViewCompat.postInvalidateOnAnimation(StickyListView.this);
        ...
        mContentView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            private void onDetectedListScroll(AbsListView absListView, int firstVisibleItem) {
                ...
                if (firstVisibleItem == oldFirstVisibleItem) {
                    if (top > oldTop) {
                        onDetectScrollListener.onScrollUp();
                    } else if (top < oldTop) {
                        onDetectScrollListener.onScrollDown();
                    }
                } else {
                    if (firstVisibleItem < oldFirstVisibleItem) {
                        onDetectScrollListener.onScrollUp();
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return p instanceof StickyListView.LayoutParams;
    }
    ...
    public android.view.ViewGroup.LayoutParams generateLayoutParams(
            AttributeSet attrs) {
        return new StickyListView.LayoutParams(getContext(), attrs);
    }
    ...
    private class FriendRefreshListView extends ListView {
        ...
        public boolean onTouchEvent(MotionEvent ev) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE:
                    int indexMove = ev.getActionIndex();
                    mActivePointerId = ev.getPointerId(indexMove);
