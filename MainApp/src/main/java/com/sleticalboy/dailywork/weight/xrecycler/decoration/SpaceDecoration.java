...
public class SpaceDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof XRecyclerAdapter) {
            headerCount = ((XRecyclerAdapter) parent.getAdapter()).getHeadersCount();
            footerCount = ((XRecyclerAdapter) parent.getAdapter()).getFootersCount();
        }
