...
public class LubanActivity extends BaseActivity {
  ...
  public static void updateGallery(Context context, File jpeg, int width, int height) {
    // 图片会被二次压缩
    // try {
    //   String result = MediaStore.Images.Media.insertImage(getContentResolver(), path, name, description);
    //   Log.d(TAG, "insertGallery() " + jpeg + ", result: " + result);
