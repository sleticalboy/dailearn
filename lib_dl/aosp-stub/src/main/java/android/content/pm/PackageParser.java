...
public class PackageParser {
  ...
  static class ParsePackageItemArgs {
    ...
    ParsePackageItemArgs(final Package owner, final String[] outError, final int nameRes, final int labelRes,
      final int iconRes, final int logoRes, final int bannerRes) {
      throw new RuntimeException("Stub!");
    }
  }
  ...
  static class ParseComponentArgs extends ParsePackageItemArgs {
    ...
    ParseComponentArgs(final Package owner, final String[] outError, final int nameRes, final int labelRes,
      final int iconRes, final int logoRes, final int bannerRes, final String[] sepProcesses, final int processRes,
      final int descriptionRes, final int enabledRes) {
  ...
  public static class PackageLite {
    ...
    public PackageLite(final String codePath, final ApkLite baseApk, final String[] splitNames,
      final String[] splitCodePaths, final int[] splitRevisionCodes) {
      throw new RuntimeException("Stub!");
    }
  ...
  public static class ApkLite {
    ...
    public ApkLite(final String codePath, final String packageName, final String splitName, final int versionCode,
      final int revisionCode, final int installLocation, final List<VerifierInfo> verifiers,
      final Signature[] signatures, final boolean coreApp, final boolean multiArch, final boolean extractNativeLibs) {
      throw new RuntimeException("Stub!");
    }
  }
  ...
  public static PackageInfo generatePackageInfo(final PackageParser.Package p, final int[] gids, final int flags,
    final long firstInstallTime, final long lastUpdateTime, final Set<String> grantedPermissions,
  ...
  public static PackageInfo generatePackageInfo(final PackageParser.Package p, final int[] gids, final int flags,
    final long firstInstallTime, final long lastUpdateTime, final Set<String> grantedPermissions,
    final PackageUserState state, final int userId) {
    throw new RuntimeException("Stub!");
  }
   ...
   * @since Android 2.3+
   */
  public Package parsePackage(final File sourceFile, final String destCodePath, final DisplayMetrics metrics,
    final int flags) {
    throw new RuntimeException("Stub!");
  }
  ...
  public static ApplicationInfo generateApplicationInfo(final Package p, final int flags,
    final PackageUserState state) {
    throw new RuntimeException("Stub!");
  }
  ...
  public static ApplicationInfo generateApplicationInfo(final ApplicationInfo ai, final int flags,
    final PackageUserState state, final int userId) {
    throw new RuntimeException("Stub!");
  }
  ...
  public static final ServiceInfo generateServiceInfo(final Service s, final int flags, final PackageUserState state,
    final int userId) {
    throw new RuntimeException("Stub!");
  }

  public static final ProviderInfo generateProviderInfo(final Provider p, final int flags, final PackageUserState state,
    final int userId) {
    throw new RuntimeException("Stub!");
  }

  public static final ActivityInfo generateActivityInfo(final Activity a, final int flags, final PackageUserState state,
    final int userId) {
    throw new RuntimeException("Stub!");
  }

  public static final ActivityInfo generateActivityInfo(final ActivityInfo ai, final int flags,
    final PackageUserState state, final int userId) {
    throw new RuntimeException("Stub!");
  }
