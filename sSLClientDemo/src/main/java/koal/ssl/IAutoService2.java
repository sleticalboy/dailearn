...
public interface IAutoService2 extends IInterface {
     ...
     * 应用名称n=监听地址:监听端口
     */
    String getApps() throws RemoteException;
     ...
     * 返回值：指定项信息
     */
    String getCertInfo(int opt) throws RemoteException;
     ...
     * [IN]port：服务器端口
     */
    void setServerAddr(String ip, String port) throws RemoteException;
     ...
     * 返回值：0 = 未链接，1=已链接
     */
    int getAppStatus(String appName) throws RemoteException;
     ...
     * [IN]save： 是否保存PIN码
     */
    void setPin(String pin, boolean save) throws RemoteException;
     ...
     * [IN]newPin： 新pin码
     */
    boolean changePin(String oldPin, String newPin) throws RemoteException;

    /**
     * 设置服务检查间隔（秒）
     * [IN]seconds： 间隔时间(秒)；0则不检查远端服务
     */
    void setCheckAppInterval(int seconds) throws RemoteException;

    /**
     * 设置显示toast消息
     * [IN]display： true=显示；false=不显示
     */
    void setDisplayToast(boolean display) throws RemoteException;
     ...
     * 证书名称n
     */
    String getCerts() throws RemoteException;

    /**
     * 设置当前证书（默认为第一张证书）
     */
    void setCurCert(String cert) throws RemoteException;

    /**
     * 使用PIN码检查设备
     */
    void checkDevice(String pin) throws RemoteException;

    /**
     * 设置TF卡型号
     */
    void setTFModel(String tf) throws RemoteException;
     ...
     * 600 = 未知错误
     */
    int checkCert(int type) throws RemoteException;
     ...
     */
    String getConfig(String key) throws RemoteException;
     ...
     */
    String getDevInfo(String key) throws RemoteException;
     ...
     */
    String getServiceInfo(String key) throws RemoteException;
}
